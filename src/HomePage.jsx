...
const Header = ({ name, tagline, activeSection, scrollToSection }) => {
...
export default function HomePage() {
  ...
  return (
    <main className="bg-gradient-to-tr from-blue-100 via-purple-100 to-pink-100 @dark:from-gray-900 @dark:via-gray-800 @dark:to-gray-900 text-gray-900 @dark:text-gray-100 min-h-screen transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4">
        ...
        <section className="md:col-span-3 p-6 space-y-8">
          ...
          <ResumeSection resumeData={homepageData.resume} />
          <ContactSection social={homepageData.social} email={homepageData.email} />
        </section>
      </div>
    </main>
  );
